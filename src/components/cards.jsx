...
function Cards() {
  return (
    <div data-scroll-section data-scroll  data-scroll-speed="-.1"  className='w-full bg-[#F1F1F1] md:h-screen flex flex-col h:fit md:flex-row mb-[30vh]  px-4 md:px-16 gap-4  '>
